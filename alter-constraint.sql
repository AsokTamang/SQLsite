ALTER TABLE staff
ALTER column dealership_id DROP NOT NULL   --here we are deleting the not null constraint which was set on the column dealership_id of the table staff
...
ALTER COLUMN seller DROP NOT NULL;   --here we are deleting the not null constraint on the column seller of sold_cars
/*
...
*/
UPDATE sold_cars SC SET seller=NULL 
FROM staff S 
WHERE SC.seller = S.id AND S.name='Frankie Fender';
